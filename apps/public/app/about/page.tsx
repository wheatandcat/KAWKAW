...
export const metadata: Metadata = {
  title: "カウカウについて - カウカウ",
  description: "カウカウは、個人が運営する架空の買い物シミュレーション・ジョークサイトです。",
};
      ...
      <div className="max-w-2xl mx-auto px-4 py-8 space-y-1.5 text-sm text-foreground leading-relaxed">
        ...
        <div className="pt-4 space-y-3">
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>すべて無料、酔狂と道楽とミツビシのおこづかいで運営されています。</li>
        ...
        <div className="pt-4 space-y-2">
          ...
          <div>
            <p>ミツビシ（X @mitsubisi）</p>
            <p className="text-muted-foreground">デザイナー。アイデア出しや架空商品開発など</p>
          </div>
          <div>
            <p>ユニコーン（blog / github）</p>
            <p className="text-muted-foreground">エンジニア。システムの設計開発など。</p>
          </div>
        </div>

        <div className="pt-4 space-y-3">
          <h2 className="font-black text-base">💡 なぜこのサイトを作ったのか</h2>
          <p>
        ...
        <div className="pt-4 space-y-3">
          <h2 className="font-black text-base">⚠️ サイトのこだわり（現実と区別するために）</h2>
          <p>間違えて本物の通販サイトで買い物をしてしまわないよう「非現実」にこだわっています。</p>
          <ul className="list-disc pl-5 space-y-1">
            <li>実在しない商品のみを掲載</li>
            <li>商品画像は使わない</li>
        ...
        <div className="pt-4 space-y-3">
          <h2 className="font-black text-base">✍️ みんなで創る「架空レビュー」</h2>
          <p>
            サイト内のレビューはすべて、ユーザーの皆様によるユーモア溢れる投稿です。 皆様の豊かな知識と想像力、ひとつまみの悪ノリがこのサイトを支えています。いつもありがとうございます！
          </p>
